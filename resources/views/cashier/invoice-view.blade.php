...
@section('content')
  ...
  <div class="container mt-4">
    ...
    <a href="{{ route('cashier.invoice.index') }}" class="btn btn-sm btn-secondary">← Back to Invoices</a>
    ...
    <div class="details-section">
      ...
      <tr>
        <td>Address</td>
        <td style="white-space:pre-line">{{ $invoice->address ?? $invoice->client->address ?? '' }}
        </td>
      </tr>
      <tr>
        <td>Contact No.</td>
